...
namespace ACwebapi
{
    public class WeatherClient
    {
        ...
        {
            var forecast = await httpClient.GetFromJsonAsync<Forecast>($"https://{settings.OpenWeatherHost}/data/2.5/weather?q={city}&appid=4db9e9c101ec3af8f0f68b22d4cf4236&units=metric");
            return forecast;
        }
    }    
}